...
class sale_order(models.Model):
    ...
    state = fields.Selection([
        ('draft', 'Quotation'),
        ('sent', 'Quotation Sent'),
        ('sale_manager_approve', 'Sale Manager Approve'),
        ('credit_limit', 'Credit Manager Approve'),
        ('cfo', 'CFO Approve'),
        ('sale', 'Sales Order'),
        ('done', 'Locked'),
        ('cancel', 'Cancelled'),
    ...
    def action_sale_manger_approve(self):
    ...
    def action_sale_ok(self):
        ...
        domain = [
            ...
            ('order_id.state', 'in', ['sale', 'sale_manager_approve','credit_limit','cfo', 'done'])]
        ...
        if partner_id.check_credit:
            partner_credit_limit = partner_id.credit_limit
            ...
            available_credit = - partner_id.credit - to_invoice_amount - draft_invoice_lines_amount

        if self.amount_total > available_credit:
            imd = self.env['ir.model.data']
            exceeded_amount = (to_invoice_amount + draft_invoice_lines_amount + partner_id.credit + self.amount_total) - partner_credit_limit
